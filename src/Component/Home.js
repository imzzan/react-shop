...
const Home = () => {
  return (
    ...
    <div className=' text-white'> 
        ...
        <Link to='/product'><motion.button variants={buttonAnimation} initial='hidden' animate='visible' whileHover='hover' className='  bg-[#00df9a] w-[200px] rounded-md font-bold my-6 mx-auto py-3'>Get Started</motion.button></Link>
        </div>
    </div>  
    </>
